...
{
    /// <inheritdoc />
    public partial class UpdateLiquidScopeFilter : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    locale = table.Column<string>(type: "TEXT", nullable: false, defaultValue: "en-AU"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a0000000-0000-0000-0000-00000000000e"), "investable", 0.050000000000000003, 0.080000000000000002, "growth", false, false, true, "long_term", "Investment bond", 9 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("b0000000-0000-0000-0000-000000000006"), "student", "neutral", true, true, "Student loan (HECS-HELP)", 6 },
